...
(defun mmm-mode-on ()
  ...
  (mmm-valid-buffer
   (unless mmm-mode
     ...
     (mmm-add-hooks)
     (mmm-fixup-skeleton)
	 ;; over-ride the following font-lock-*-functions
     ...
     (setq font-lock-fontify-buffer-function 'mmm-fontify-buffer
		   font-lock-fontify-region-function 'mmm-fontify-region
...
(defun mmm-mode-off ()
  ...
  (when mmm-mode
    ...
    (setq font-lock-fontify-buffer-function
		  (get mmm-primary-mode 'mmm-fontify-buffer-function)
