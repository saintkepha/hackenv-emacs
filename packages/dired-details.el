...
;; Version: 1.3
;; Keywords: dired, hide
;; Author: Rob Giardina <address@hidden>
...
(defcustom dired-details-hidden-string "[...]"
  "*This string will be shown in place of file details and symbolic
links."
  :group 'dired-details
  :type 'string)
...
dired-details-internal-overlay-list)))
            (if cached-overlays
              ...
              (let ((cache (list (car dir-and-pos)))
                    ...
                    (subdir-end (1- (dired-get-subdir-max
dir-and-pos))))
...
(defun dired-details-frob-overlays( hide )
  (if dired-details-internal-overlay-list
      (mapc '(lambda(list)
               (mapc (if hide 'dired-details-hide-overlay
